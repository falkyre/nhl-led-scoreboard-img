...
function display-release {
  ...
  function fmt:hash {
    ...
    md) printf "[\`$hash\`](https://github.com/falkyre/nhl-led-portal-img/commits/$hash)" ;;
    esac
  }
  ...
  function fmt:subject {
    ...
    md) sed -E 's|#([0-9]+)|[#\1](https://github.com/falkyre/nhl-led-portal-img/issues/\1)|g' <<< "$subject" ;;
    esac
  }
