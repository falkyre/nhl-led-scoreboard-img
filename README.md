...
<img src="https://github.com/falkyre/nhl-led-scoreboard/blob/main/assets/images/scoreboard.jpg" height="150">
</a>
</p>
...
2. Open Etcher and select the `rpios-scoreboard-v0.0.0.xz` file you have [downloaded](https://github.com/falkyre/nhl-led-scoreboard-img/releases/latest). There is no need to extract the `.gz` file first.
