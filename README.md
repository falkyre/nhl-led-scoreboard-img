...
* Works on Raspberry Pi models zero **_2w up to the pi 4_**.  The pi zero w will crash and the pi 5 requires a rewrite of the software due to how it handles GPIO now.
